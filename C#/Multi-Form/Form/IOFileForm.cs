...
namespace mem_hkj
{
    public partial class IOFileForm : Form
    {
        ...
        public IOFileForm(IOUtil util, List<String> indexList)
        {
            ...
            this.model.serial = indexList[0];
            this.txtText.Text = indexList[1]; //txtText代入
            this.model.contents = indexList[1];
            String day = indexList[2]; //cbx代入
            this.model.pulldown = indexList[2];
            ...
            this.model.direction = indexList[3];

            String checkText = indexList[4];
            this.model.check = indexList[4];
            ...
            Console.WriteLine(indexList[5]);
            this.model.number = Convert.ToInt32(indexList[5]);
            setComma(txtNum);
            this.txtNumEng.Text = indexList[6]; //txtEngNumに代入
            this.model.engnum = indexList[6];
        ...
        {
            if (!model.SetData(this))
            {
                MessageBoxEx.Show(this, IOText.ERROR_CONTENTS, IOText.ERROR_MESSAGE, MessageBoxButtons.OK);
                return null;
            }
            return model;
        }
